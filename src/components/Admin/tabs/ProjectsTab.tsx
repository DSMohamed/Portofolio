    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {projects.map(p => (
          <div
            key={p.id}
            className="p-5 rounded-2xl bg-[#0c0c11] border border-white/[0.08] flex flex-col justify-between space-y-4 group hover:border-amber-400/30 transition-all"
          >
            <div className="flex items-start gap-4">
              <img
                src={p.image}
                alt={p.title}
                className="w-20 h-20 rounded-xl object-cover border border-white/10 shrink-0 bg-black"
              />
              <div className="space-y-1 min-w-0">
                ...
                <h3 className="font-bold text-white font-display text-base truncate">
                  {p.title}
                </h3>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-white/[0.05] text-xs font-mono">
              <div className="flex flex-wrap gap-1">
                {p.tags.slice(0, 3).map((t, idx) => (
                  <span key={idx} className="px-2 py-0.5 rounded bg-white/[0.03] text-zinc-400 text-[10px]">
                    {t}
                  </span>
                ))}
              </div>
      ...
      {editingProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 rounded-3xl bg-[#0e0e14] border border-white/10 shadow-2xl text-zinc-200">
            ...
            <form onSubmit={handleSaveModal} className="space-y-4 text-xs font-mono">
              ...
              <div className="space-y-1.5">
                <label className="text-zinc-400 uppercase">Tagline</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-zinc-400 uppercase">Short Description (Card) *</label>
                <textarea
                  rows={2}
                  required
              ...
              <div className="space-y-1.5">
                <label className="text-zinc-400 uppercase">Long Architectural Description (Modal)</label>
                <textarea
                  rows={3}
              ...
              <div className="space-y-1.5">
                <label className="text-zinc-400 uppercase">Cover Image URL *</label>
                <input
                  type="url"
                  required
              ...
              <div className="space-y-1.5">
                <label className="text-zinc-400 uppercase">Tech Tags (Comma separated)</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-zinc-400 uppercase">Live Demo URL</label>
                  <input
                    type="url"
                ...
                <div className="space-y-1.5">
                  <label className="text-zinc-400 uppercase">GitHub Repo URL</label>
                  <input
                    type="url"
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                />
                <label htmlFor="featuredCheck" className="text-zinc-300 cursor-pointer">

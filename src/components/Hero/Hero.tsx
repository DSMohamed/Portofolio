...
export const Hero: React.FC<HeroProps> = () => {
  ...
  return (
    <section 
      id="hero" 
      className="relative w-full h-[100svh] min-h-[650px] overflow-hidden bg-[#08080a] flex items-end justify-start"
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 pb-20 sm:pb-24 lg:pb-24 pointer-events-none">
        <div className="max-w-2xl text-left">
          
          {/* Eyebrow badge with status indicator */}
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full border border-white/15 bg-black/60 backdrop-blur-md mb-4 pointer-events-auto shadow-lg shadow-black/40">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-amber-500"></span>
            </span>
            <span className="font-mono text-[11px] sm:text-xs font-semibold tracking-widest text-zinc-300 uppercase">
              {personalInfo.eyebrow}
            </span>
          </div>

          {/* Large Name / Title */}
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black font-display tracking-tight text-white uppercase leading-[0.95] mb-4 drop-shadow-2xl">
          ...
          <p className="text-sm sm:text-base lg:text-lg font-light text-zinc-300 leading-relaxed max-w-xl mb-6 drop-shadow-md">
      ...
      <div className="absolute bottom-4 sm:bottom-6 inset-x-0 z-20 px-6 sm:px-12 lg:px-16 pointer-events-none">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-3 text-[11px] font-mono text-zinc-400 tracking-wider">
          ...
          <div 
            ...
            className="pointer-events-auto cursor-pointer ml-auto flex items-center gap-2 bg-black/50 hover:bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 hover:border-white/25 text-zinc-400 hover:text-zinc-200 transition-all duration-200 shadow-lg"
          >
